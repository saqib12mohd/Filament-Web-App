                ...
                <div class="col-lg-2 col-md-4 col-6 mb-4">
                    <div class="footer-widget">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li class="mb-2"><a wire:navigate href="{{ route('servicesPage',$service->id) }}">{{ $service->title }}</a>
                            </li>
                            @endforeach
                ...
                <div class="col-lg-2 col-md-4 col-6 mb-4">
                    <div class="footer-widget">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li class="list-inline-item me-4"><a class="text-black" href="{{ route("page",4) }}" wire:navigate>Terms &amp;
                                    Conditions</a>
                            </li>
                        </ul>
                    </div>
